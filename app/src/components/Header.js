...
import { lowercaseAddress, validateContractAddress } from '../utils/helpers';
        ...
        <Box w={{ base: 'full', lg: 'auto' }}>
          <InputGroup size={{ base: 'sm', lg: 'md' }}>
            ...
            <Input
              ...
              defaultValue={!userAddress ? '' : lowercaseAddress(address)}
              outline={
              ...
              onBlur={(e) => {
                setAddress(lowercaseAddress(e.target.value));
                validateContractAddress(
                  address,
                  userAddress,
                  validationResult,
